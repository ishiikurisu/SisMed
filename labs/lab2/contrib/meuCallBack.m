...
%MEUCALLBACK A��o tomada a um evento da porta
%   L� entrada e plota

    % L� dados de entrada do serial e coloc�-os em um vetor de double
    valor = fscanf(serial);
...
%         end
        ...
        display(strcat('M�dia = ', num2str(media(cont))));
        display(strcat('M�dia M�vel (n = 20) = ', num2str(mediaMovel_20(cont))));
        display(strcat('M�dia M�vel (n = 100) = ', num2str(mediaMovel_100(cont))));
        display(strcat('M�dia M�vel Ponderada(a = 0.9) = ', num2str(mediaMovelPonderada_09(cont))));
        display(strcat('M�dia M�vel Ponderada(a = 0.7) = ', num2str(mediaMovelPonderada_07(cont))));
        display(strcat('M�dia M�vel Ponderada(a = 0.5) = ', num2str(mediaMovelPonderada_05(cont))));
    end
end
